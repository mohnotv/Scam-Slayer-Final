...
def _mock_chunks() -> list[TranscriptChunk]:
    ...
    return [
        TranscriptChunk("Hello, this is the IRS.", is_final=True, timestamp_ms=1200, confidence=0.98),
        TranscriptChunk("You owe back taxes.", is_final=True, timestamp_ms=3400, confidence=0.97),
        TranscriptChunk("You must pay immediately or face arrest.", is_final=True, timestamp_ms=6100, confidence=0.95),
    ]
